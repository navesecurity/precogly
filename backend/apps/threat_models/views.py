    ...
    def _serialize_countermeasures_from_links(self, links, current_threat):
        ...
        for link in links:
            ...
            result.append({
                ...
                "verification_procedure": (cm.countermeasure_library.verification_procedure if cm.countermeasure_library else None) or cm.verification_procedure,
                "expected_result": (cm.countermeasure_library.expected_result if cm.countermeasure_library else None) or cm.expected_result,
                "status": cm.status,
